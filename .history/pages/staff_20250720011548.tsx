...
import { Card, CardContent, CardHeader, CardTitle, Badge, Dialog, DialogContent, DialogHeader, DialogTitle, Input, Label, Alert, AlertDescription } from "../components/ui/index";
